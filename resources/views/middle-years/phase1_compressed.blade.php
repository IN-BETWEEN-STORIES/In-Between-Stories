...
<section id="phase1" class="relative w-full">
    ...
    {{-- Gedung 3 --}}
    <img src="{{ asset('/assets/middle-years/new_phase1/gedung3.webp') }}" alt="Gedung 3" id="phase1_gedung3"
        class="absolute w-[99%] top-0 right-[-7.4%] z-[2]" loading="eager">

    {{-- Gedung 2 --}}
    <img src="{{ asset('/assets/middle-years/new_phase1/gedung2.png') }}" alt="Gedung 2" id="phase1_gedung2"
