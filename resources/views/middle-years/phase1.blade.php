...
<section id="phase1" class="relative w-full">
    ...
    {{-- Gedung 3 --}}
    <img src="{{ asset('/assets/middle-years/new_phase1/gedung belakang atas.png') }}" alt="Gedung 3" id="phase1_gedung3"
        class="absolute w-[93%] top-0 right-[0%] z-[2]" loading="eager">

    {{-- Gedung 2 --}}
    <img src="{{ asset('/assets/middle-years/new_phase1/gedung_2.png') }}" alt="Gedung 2" id="phase1_gedung2"
    ...
    <div>
        ...
        {{-- Coffee Pour --}}
        <img src="{{ asset('/assets/middle-years/new_phase1/coffe_pour.png') }}" alt="Coffee Pour" id="phase1_pour"
            class="absolute w-[8.5%] top-[-16.75%] left-[49%] z-[4] coffee_grp cursor-pointer" loading="eager">
        {{-- Cangkir depan --}}
        <img src="{{ asset('/assets/middle-years/new_phase1/kopi_depan.webp') }}" alt="Kopi" id="phase1_kopi_depan"
            class="absolute w-[44%] top-[2.5%] left-[34.5%] z-[5] coffee_grp cursor-pointer" loading="eager">
        {{-- Tangan megang kopi --}}
        <img src="{{ asset('/assets/middle-years/new_phase1/tangan_kopi.webp') }}" alt="Kopi" id="phase1_tangan_kopi"
            class="absolute w-[67%] top-[8.25%] left-[31.5%] z-[5] coffee_grp cursor-pointer" loading="eager">
    </div>

    {{-- Gedung 1 --}}
    <img data-src="{{ asset('/assets/middle-years/new_phase1/gedung1.webp') }}" alt="Gedung 1" id="phase1_gedung1"
        class="absolute w-[31%] top-[20.2%] left-[24.5%] z-[2] lazy-load" loading="lazy">

    {{-- Tanaman ijo sebelah kanan (balik e jam) --}}
    <img data-src="{{ asset('/assets/middle-years/new_phase1/tanaman_depan_tangan_kopi.webp') }}" alt="Tanaman Depan"
        id="phase1_tanaman_depan" class="absolute w-[30%] top-[25.75%] right-0 z-[6] lazy-load" loading="lazy">

    {{-- gedung belakang maureen atas --}}
    <img data-src="{{ asset('/assets/middle-years/new_phase1/gedung_belakang_maureen_atas.png') }}"
    ...
    {{-- Koper & Lemari --}}
    <img data-src="{{ asset('/assets/middle-years/new_phase1/koper_lemari.webp') }}" alt="Koper & Lemari"
        id="phase1_koper_lemari" class="absolute w-[95%] top-[41.5%] right-0 z-[6] lazy-load" loading="lazy">

    {{-- kertas2 jatuh --}}
    <div>
        {{-- Kertas jatuh 2 --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/kertas_jatuh_2.png') }}" alt="Kertas Jatuh 2"
            id="phase1_kertas_jatuh_2" class="absolute w-[26%] top-[29.25%] left-[13%] z-[4] lazy-load" loading="lazy">
        {{-- Kertas jatuh 3 --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/kertas_jatuh_3.png') }}" alt="Kertas Jatuh 3"
            id="phase1_kertas_jatuh_3" class="absolute w-[24%] top-[36.68%] left-[3%] z-[4] lazy-load" loading="lazy">
        {{-- Kertas jatuh 4 --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/kertas_jatuh_4.png') }}" alt="Kertas Jatuh 4"
            id="phase1_kertas_jatuh_4" class="absolute w-[16%] top-[45.9%] left-[11.5%] z-[12] lazy-load"
            loading="lazy">
        {{-- Kertas jatuh 7 --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/kertas_jatuh_7.png') }}" alt="Kertas Jatuh 7"
            id="phase1_kertas_jatuh_7" class="absolute w-[21.3%] top-[47.8%] left-[0%] z-[12] lazy-load" loading="lazy">
        {{-- Kertas jatuh 5 --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/kertas_jatuh_5.png') }}" alt="Kertas Jatuh 5"
            id="phase1_kertas_jatuh_5" class="absolute w-[17%] top-[57.5%] left-[14%] z-[12] lazy-load" loading="lazy">
        {{-- Kertas jatuh 6 --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/kertas_jatuh_6.png') }}" alt="Kertas Jatuh 6"
    ...
    <div>
        {{-- anting kiri --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/anting1.png') }}" alt="Anting Kiri" id="anting_kiri"
            class="absolute w-[9.6%] top-[24.15%] left-[55.15%] z-[4] lazy-load" loading="lazy">
        {{-- anting kanan --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/anting2.png') }}" alt="Anting Kanan" id="anting_kanan"
    ...
    <div>
        {{-- Laci 2 --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/laci.webp') }}" alt="Laci 2" id="phase1_laci_2"
            class="absolute w-[79.5%] top-[55.15%] right-[-9.5%] z-[9] lazy-load" loading="lazy">
        {{-- Kertas laci 2 --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/kertas_laci_2.png') }}" alt="Laci"
    ...
    <div>
        {{-- Laci 3 --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/laci.webp') }}" alt="Laci 3" id="phase1_laci_3"
            class="absolute w-[79.5%] top-[65.84%] right-[-9.5%] z-[11] lazy-load" loading="lazy">
        {{-- Kertas laci 3 / kertas --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/kertas_laci_3.png') }}" alt="Kertas Laci 3"
            id="phase1_kertas_laci_3"
            class="absolute w-[33%] top-[59.02%] left-[66%] z-[9] lazy-load cursor-pointer kertas_bawah"
            loading="lazy">
        {{-- Kertas laci 4 / bunga --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/kertas_laci_4.png') }}" alt="Bunga"
    ...
    {{-- Background pasir --}}
    <img data-src="{{ asset('/assets/middle-years/new_phase1/bg_pasir_bawah.webp') }}" alt="Background Pasir"
        id="phase1_bg_pasir" class="absolute w-full bottom-0 z-[5] lazy-load" loading="lazy">

    {{-- Gedung + koper bawah --}}
    <div>
        {{-- Gedung bawah --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/gedung_bawah.webp') }}" alt="Gedung Bawah"
            id="phase1_gedung_bawah" class="absolute w-[68%] bottom-[14.75%] left-0 z-[12] lazy-load" loading="lazy">

        {{-- Koper bawah --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/koper_bawah.webp') }}" alt="Koper Bawah"
    ...
    <div>
        {{-- Jalan bawah --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/jalan_bawah.webp') }}" alt="Jalan Bawah"
            id="phase1_jalan_bawah" class="absolute w-[61%] bottom-0 z-[12] lazy-load" loading="lazy">

        {{-- Mobil ijo tua --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/mobil_ijo.png') }}" alt="Mobil 1" id="phase1_mobil1"
            class="absolute w-[14.5%] bottom-[9.25%] left-[24.5%] z-[12] lazy-load" loading="lazy">

        {{-- Mobil merah --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/mobil_merah.png') }}" alt="Mobil 2" id="phase1_mobil2"
            class="absolute w-[26%] bottom-[4.25%] left-[20.25%] z-[12] lazy-load" loading="lazy">

        {{-- Mobil ijo muda --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/mobil_ijo_muda.png') }}" alt="Mobil 3" id="phase1_mobil3"
            class="absolute w-[16.6%] bottom-[5.75%] left-0 z-[12] lazy-load" loading="lazy">

        {{-- Orang kiri --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/kim_bawah.png') }}" alt="Orang Bawah 1"
            id="phase1_orang_bawah1" class="absolute w-[9%] bottom-[8%] left-[15.25%] z-[12] lazy-load"
            loading="lazy">

        {{-- Orang tengah --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/karyn_bawah.png') }}" alt="Orang Bawah 2"
    ...
    <div>
        ...
        <div>
            ...
            {{-- Merah --}}
            <img data-src="{{ asset('/assets/middle-years/new_phase1/tas_merah.png') }}" alt="Tas Merah"
                id="phase1_tas_merah" class="absolute w-[15%] bottom-[12.75%] right-[32%] z-[15] lazy-load"
                loading="lazy">

            {{-- Ijo --}}
            <img data-src="{{ asset('/assets/middle-years/new_phase1/tas_ijo.png') }}" alt="Tas Ijo" id="phase1_tas_ijo"
                class="absolute w-[16%] bottom-[12%] right-[24.75%] z-[16] lazy-load" loading="lazy">
            <img data-src="{{ asset('/assets/middle-years/new_phase1/tas_ijo.png') }}" alt="Tas Ijo"
        ...
        {{-- Tumpukan barang --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/tumpukan_barang.png') }}" alt="Tumpukan Barang"
            id="phase1_tumpukan_barang" class="absolute w-[27%] bottom-[11.75%] right-[17.5%] z-[13] lazy-load"
            loading="lazy">

        {{-- Kertas & tumbuhan blkg pintu --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/kertas_tumbuhan_pintu.png') }}" alt="Kertas dan Tumbuhan"
    ...
    <div>
        {{-- Lebah telpon --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/lebah_telpon.png') }}" alt="Lebah Telpon"
        ...
        <div class="lebah4-container absolute w-[25%] bottom-[23%] right-[38%] z-[25]">
            <img src="{{ asset('/assets/middle-years/new_phase1/lebah_4.png') }}" alt="Lebah 4" id="phase1_lebah_4"
        ...
        {{-- lebah 3 --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/lebah_3.png') }}" alt="Lebah 3" id="phase1_lebah_3"
        ...
        <div class="lebah1-container absolute w-[11%] top-[10%] left-[16.75%] z-[25]">
            <img src="{{ asset('/assets/middle-years/new_phase1/lebah_1.png') }}" alt="Lebah 1" id="phase1_lebah_1"
        ...
        <div class="lebah2Atas-container absolute w-[19%] top-[12%] right-[5%] z-[25]">
            <img src="{{ asset('/assets/middle-years/new_phase1/lebah_2.png') }}" alt="Lebah 2 atas"
        ...
        {{-- lebah 2 --}}
        <img data-src="{{ asset('/assets/middle-years/new_phase1/lebah_2.png') }}" alt="Lebah 2" id="phase1_lebah_2"
        ...
        <div class="lebah4Atas-container absolute w-[8%] top-[4.5%] right-[23.4%] z-[25]">
            <img src="{{ asset('/assets/middle-years/new_phase1/lebah_4.png') }}" alt="Lebah 4 atas"
